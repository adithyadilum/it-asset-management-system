...
interface EditableSchemaSectionProps {
    ...
    onUpdate: <TKey extends keyof CustomAttribute>(id: string, key: TKey, value: CustomAttribute[TKey]) => void;
    onAdd: () => void;
                        ...
                        <div key={attribute.id} className="grid grid-cols-12 items-center gap-4 p-1">
                            ...
                            <div className="col-span-4">
                                <Select
                                    ...
                                    onValueChange={(value) =>
                                        onUpdate(attribute.id, "inputType", value as CustomAttribute["inputType"])
                                    }
                                >
