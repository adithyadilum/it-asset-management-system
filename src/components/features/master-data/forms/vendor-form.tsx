...
export function VendorForm({
    ...
    }, [companyName, email, phone, website, isActive, initialData, onDirtyStateChange]);
    ...
    return (
        <>
            ...
            {isEdit && initialData && (
                <RecordIdPreview entity="vendors" record={initialData as unknown as Record<string, unknown>} numericRecordId={initialData.id} />
            )}
