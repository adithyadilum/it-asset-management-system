...
export function MasterDataCreatePanel({
    ...
    const [state, setState] = useState<UpdateMasterDataState>(INITIAL_CREATE_MASTER_DATA_STATE);
    ...
    const handleSubmit = useCallback(
        (event: FormEvent<HTMLFormElement>) => {
            ...
            if (!normalizedEntity) {
                ...
                setState({ success: false, message: "Invalid master data entity selected." });
                return;
            }
    ...
    const formBody = (() => {
        ...
        switch (normalizedEntity) {
            case "locations":
                return <LocationForm key={normalizedEntity} locations={locations} fieldError={getFieldError} />;
            case "asset-categories":
                return <CategoryForm key={normalizedEntity} fieldError={getFieldError} />;
            case "brands":
                return <BrandForm key={normalizedEntity} fieldError={getFieldError} />;
            case "device-models":
                return <DeviceModelForm key={normalizedEntity} ref={formRef} brands={brands} categories={categories} fieldError={getFieldError} />;
            case "vendors":
            ...
            case "departments":
                return <DepartmentForm key={normalizedEntity} fieldError={getFieldError} />;
            case "statuses":
