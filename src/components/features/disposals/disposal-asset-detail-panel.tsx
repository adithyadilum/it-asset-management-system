          ...
          <div className="flex flex-col gap-6 py-4 px-2">
            <div className="grid grid-cols-2 gap-y-4 text-sm">
              <div className="flex flex-col gap-1">
                <span className="text-muted-foreground text-[12px] uppercase tracking-wider font-semibold">
                  Disposal Status
                </span>
                <div className="pt-1">
                  <StatusBadge
                    value={
                      disposalDetails.status === 'Completed'
                        ? 'disposed'
                        : disposalDetails.status.toLowerCase()
                    }
                    label={
                      disposalDetails.status === 'Completed'
                        ? 'Disposed'
                        : disposalDetails.status
                    }
                  />
                </div>
              </div>
            ...
            {disposalDetails.documentUrls &&
              disposalDetails.documentUrls.length > 0 && (
