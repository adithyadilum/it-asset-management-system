      ...
      try {
        ...
        tiqriToast.error(
          error instanceof Error
            ? error.message
            : 'Failed to submit disposal requests.'
        );
      }
    });
  };
        ...
        <div className="grid gap-5 py-2 max-h-[60vh] overflow-y-auto pr-2">
          <div className="grid gap-2">
            ...
            <p className="text-[0.8rem] text-muted-foreground">
              These assets will be flagged as <strong>Pending Disposal</strong>{' '}
              for Global Admin review.
            </p>
          </div>
          ...
          <div className="grid gap-2">
            ...
            <Select value={reason} onValueChange={setReason}>
              ...
              <SelectContent>
                <SelectItem value="Damaged beyond repair">
                  Damaged beyond repair
                </SelectItem>
                <SelectItem value="End of life / Obsolete">
                  End of life / Obsolete
                </SelectItem>
                <SelectItem value="Lost / Stolen">Lost / Stolen</SelectItem>
                <SelectItem value="Security compromise">
                  Security compromise
                </SelectItem>
                <SelectItem value="Excess inventory">
                  Excess inventory / Unused
                </SelectItem>
          ...
          <div className="flex items-start gap-3 rounded-md border border-primary/20 bg-primary/10 p-3 text-sm text-primary">
            ...
            <p>
              Submitting this request will flag the assets as{' '}
              <strong>Pending Disposal</strong>. A <strong>Global Admin</strong>{' '}
              must approve before final disposal is executed.
            </p>
          </div>
        </div>
