...
export function getDaysPendingStatus(days: number): "critical" | "warning" | "neutral" {
...
export function usePendingDisposalColumns(userRole: string): ColumnDef<PendingDisposalRow>[] {
...
export function useHighMaintenanceColumns(onFlag: (asset: HighMaintenanceRow) => void): ColumnDef<HighMaintenanceRow>[] {
  return useMemo(() => [
    {
      id: "asset",
      header: "Asset ID",
...
export function useTopHighValueAssetsColumns(currencyCode: string = "LKR", exchangeRate: number = 1): ColumnDef<TopHighValueAssetRow>[] {
  return useMemo(() => [
    {
      id: "asset",
      header: "Asset",
