...
/**
 * Placeholder for the dashboard while its data streams in.
 *
 * Lives here rather than in `loading.tsx` so the page's own `<Suspense>`
 * boundary can use it too. A generic table skeleton standing in for a grid of
 * KPI cards and charts is a jarring swap; this mirrors the real layout — four
 * hero KPIs, four secondary, three charts, two tables.
 */
