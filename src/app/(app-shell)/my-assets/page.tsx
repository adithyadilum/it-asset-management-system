...
import { AppWindow, HardDrive, Laptop, Monitor, Smartphone, Code, Armchair, Speaker } from "lucide-react"
...
export default async function MyAssetsPage() {
    ...
    return (
        <section className="px-4 pb-4 pt-6 md:px-6 md:pb-6">
            <h1 className="text-foreground text-2xl font-semibold leading-8">My Assets</h1>
            <p className="text-muted-foreground text-base font-normal leading-6">Here are the assets and software currently assigned to you.</p>
            ...
            {hasAnyAssets ? (
                <div className="mt-4 space-y-8">
                    ...
                    {softwareAssets.length > 0 ? (
                        <section>
                            <h2 className="text-lg font-semibold text-foreground">Software Access</h2>
                            <div className="mt-3 grid gap-4 xl:grid-cols-3">
                        ...
                        <Empty className="min-h-52 rounded-md border-0 p-4">
                            <EmptyHeader className="max-w-md">
                                ...
                                <EmptyDescription className="max-w-md text-balance">
                                    We couldn&apos;t find any equipment or software linked to your profile.
                                    <br />
                                    If you&apos;re expecting access, please check back later or contact the IT Helpdesk.
                                </EmptyDescription>
                            </EmptyHeader>
                        </Empty>
                    </div>
