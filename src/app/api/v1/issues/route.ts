...
// Reporting an issue forces the asset into "In Repair" and terminates its active
// assignments, so it requires asset-management rights, not merely a session.
export const POST = withRateLimit(
  'issues',
  withAuth(canManageAssets, async (req, { user }) => {
