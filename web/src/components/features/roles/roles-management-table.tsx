...
export function RolesManagementTable({ users, roleLabel }: RolesManagementTableProps) {
        ...
        <>
            <div className="self-stretch w-full overflow-hidden rounded-lg border border-slate-200 bg-white">
                <table className="w-full border-collapse">
                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user.id} className="h-12.25 border-b border-slate-200 last:border-b-0">
                                ...
                                <td className="w-18.75 px-3.5 py-2">
                                    <button
                                        type="button"
                                        className="flex h-8 w-full items-center gap-2 rounded-lg px-2.5 py-0"
