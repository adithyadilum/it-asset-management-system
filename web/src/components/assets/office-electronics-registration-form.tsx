...
type OfficeElectronicsRegistryPageClientProps = {
...
export function OfficeElectronicsRegistryPageClient({
  categoryOptions,
  brandOptions,
  locationOptions,
  vendorOptions,
}: OfficeElectronicsRegistryPageClientProps) {
  ...
  const [ipOrMacAddress, setIpOrMacAddress] = React.useState('');
  ...
  const panelBody = (
    <div className={cn('space-y-4', isPending && 'pointer-events-none opacity-70')}>
      ...
      <CircleImageUpload
        inputId="officeElectronicsImage"
        inputName="officeElectronicsImage"
        previewUrl={imagePreviewUrl}
        onChange={handleImageChange}
        label="Upload office electronics image"
      />
      ...
      <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
        ...
        >
          <Input
            id="ipOrMacAddress"
            name="ipOrMacAddress"
            value={ipOrMacAddress}
            onChange={(event) => setIpOrMacAddress(event.target.value)}
            placeholder="192.168.1.10 or 00:1A:2B:3C:4D:5E"
          />
        </FieldRow>
    ...
    <div className="flex min-h-0 flex-1 overflow-hidden p-4 md:p-6">
      <div className="flex min-h-0 flex-1 flex-col rounded-xl border border-border bg-background">
        <div className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-b border-border p-4">
          <div>
            <h1 className="text-lg font-semibold text-foreground">Office Electronics Registry</h1>
            <p className="mt-1 text-sm text-muted-foreground">
              Register and manage office electronics assets.
            </p>
          </div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    >
                      Office electronics list integration can be mounted here.
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
