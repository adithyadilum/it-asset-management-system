...
const MOCK_ASSET_ID = 'ELC-PRT-001';
  ...
  return (
    <div className="flex flex-col h-full gap-6">
      <div className="shrink-0">
        <h1 className="text-3xl font-bold text-slate-900">Office Electronics</h1>
        <p className="text-sm text-slate-600 mt-1">Test the slide-out panel for office electronics</p>
      </div>
      ...
      <div className="flex flex-1 min-h-0 flex-row">
        ...
        <div className="flex-1 bg-white rounded-lg border border-slate-200 border-dashed flex flex-col items-center justify-center gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-slate-500 mt-2">Space reserved for electronics list grid (Epic 6)</p>
          </div>
        ...
        {assetData && (
          <AssetDetailsPanel
            ...
            assetCategory="Office Electronics"
            ...
            onActionButtonClick={() => alert('Request Return functionality coming soon')}
