...
const MOCK_ASSET_ID = 'HW-LAP-001';
  ...
  return (
    <div className="flex flex-col h-full gap-6">
      <div className="shrink-0">
        <h1 className="text-3xl font-bold text-slate-900">Hardware Assets</h1>
        <p className="text-sm text-slate-600 mt-1">Test the slide-out panel for hardware assets</p>
      </div>
      ...
      <div className="flex flex-1 min-h-0 flex-row">
        ...
        <div className="flex-1 bg-white rounded-lg border border-slate-200 border-dashed flex flex-col items-center justify-center gap-6">
          <div className="text-center">
            ...
            <p className="text-sm text-slate-500 mt-2">Space reserved for asset list grid (Epic 6)</p>
          </div>
