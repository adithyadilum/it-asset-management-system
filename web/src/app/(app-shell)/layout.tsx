...
const getShellUser = cache(async (): Promise<ShellUser | null> => {
    ...
    try {
        ...
        const payload = verified.payload as { name?: unknown; email?: unknown; role?: unknown }
...
>>>>>>> e344588 (fix(assets): resolve PR review feedback and merge conflicts)

    return (
        <ShadcnSidebarProvider defaultOpen style={{ "--sidebar-width": "260px" } as CSSProperties}>
