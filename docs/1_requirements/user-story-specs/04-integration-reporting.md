...
- **Read-Only**: For this phase, external systems generally cannot _write_ or _delete_ assets via public API.
...
- **Data Scope**: Auditors should see _all_ data; Department Admins (future) might be scoped. Global Admin sees everything.
...
![alt text](images/wireframe-dashboard.png)
